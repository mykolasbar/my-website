    ...
    return (<>
            ...
            <div id = "projectssection">
                <div style={{display:"flex", flexDirection:"column"}}>
                    <div onClick = {()=>{props.selectImage('projects-1.png'); props.displayImage()}} style = {{cursor: "pointer", backgroundImage: "URL(projects-1.png)", backgroundSize: "contain", backgroundRepeat:"no-repeat", width: window.innerWidth > 480 ? "350px" : "90%", height:"200px", marginBottom:"5px"}}></div>
                ...
                <div style={{display:"flex", flexDirection:"column"}}>
                    <div onClick = {()=>{props.selectImage('projects-2.png'); props.displayImage()}} style = {{cursor: "pointer", backgroundImage: "URL(projects-2.png)", backgroundSize: "contain", backgroundRepeat:"no-repeat", width: window.innerWidth > 480 ? "350px" : "90%", height:"200px", marginBottom:"5px"}}></div>
